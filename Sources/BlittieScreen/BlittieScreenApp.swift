...
// With no --video-url argument, BlittieScreen starts as a daemon: no window,
...
let launchVideoPayload: String? = {
    ...
    guard valueIndex < args.endIndex else {
        ...
        Usage: swift run BlittieScreen [--video-url <url-or-share-text>]
        ...
        Example:
          swift run BlittieScreen --video-url "https://www.youtube.com/watch?v=dQw4w9WgXcQ"
